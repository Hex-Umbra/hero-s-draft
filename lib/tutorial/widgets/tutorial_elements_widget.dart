...
class _TutorialElementsWidgetState extends State<TutorialElementsWidget> {
  ...
  static const List<ElementStatusInfo> _elements = [
    ElementStatusInfo(
      ...
      nameEn: 'Poison',
      nameFr: 'Poison',
      descEn: 'Deals damage equal to its value at start of turn, then decreases by 1.',
      descFr: 'Inflige des dégâts égaux au Poison au début du tour, puis diminue de 1.',
    ),
    ElementStatusInfo(
      ...
      nameEn: 'Burn',
      nameFr: 'Brûlure',
      descEn: 'Deals damage equal to its value at end of turn, then decreases by half.',
      descFr: 'Inflige des dégâts de Feu à la fin du tour, puis diminue de moitié.',
    ),
    ElementStatusInfo(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Icon(element.icon, color: element.color, size: 24),
                  ),
                  ...
                  Container(
                    ...
                    child: Center(
                      child: _buildSimulationVisual(index),
                    ),
                  ),
                ],
              ),
