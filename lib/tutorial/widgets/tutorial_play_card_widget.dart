                ...
                children: [
                    ...
                    onTap: () {
                      ...
                      if (success) {
                        if (_selectedCard!.damage > 0) {
                          _triggerFloatingText('-${_selectedCard!.damage} HP', Colors.redAccent);
                        } else if (_selectedCard!.armor > 0) {
                          _triggerFloatingText('+${_selectedCard!.armor} 🛡️', Colors.blueAccent);
                        }
                        setState(() {
                          _selectedCard = null;
                        });
                          ...
                          children: [
                            ...
                            TweenAnimationBuilder<double>(
                              ...
                              child: Icon(
                                ...
                                size: 55,
                                color: enemy.hp > 0 ? Colors.greenAccent : Colors.grey,
                              ),
                            ),
                  ...
                  if (_showFloatingText)
                    AnimatedPositioned(
                      ...
                      top: 40 + _floatingYOffset,
                      child: AnimatedOpacity(
                        duration: const Duration(milliseconds: 700),
                        opacity: _showFloatingText ? 0.0 : 1.0, // Fades out
                        child: Text(
                          _floatingText,
                          style: TextStyle(
                        ...
                        children: List.generate(3, (index) {
                          ...
                          return Padding(
                            ...
                            child: Icon(
                              ...
                              color: active ? Colors.cyanAccent : Colors.cyan.withOpacity(0.15),
                              size: 14,
                            ),
                          );
                        }),
