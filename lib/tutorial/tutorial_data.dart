...
const List<TutorialStep> kTutorialSteps = [
  ...
  TutorialStep(
    ...
    bodyEn:
        ...
        'Winning a fight refills your Mana, whether or not it also levels '
        'you up. Note that your hero\'s XP '
    ...
    bodyFr:
        ...
        'draftées**.\n\n'
        'Gagner un combat restaure votre Mana, que ce combat vous fasse '
        'gagner un niveau ou non. '
