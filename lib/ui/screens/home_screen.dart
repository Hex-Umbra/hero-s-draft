...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // SafeArea + defilement : la colonne a grandi (bouton Reglages en
      // plus) et deborde desormais sur les surfaces basses (voir l'audit
      // responsive du 05/08). SingleChildScrollView + ConstrainedBox garde
      // le contenu centre quand il tient, et defilable sinon, plutot que de
      // le laisser deborder silencieusement hors ecran.
      body: SafeArea(
        child: LayoutBuilder(
