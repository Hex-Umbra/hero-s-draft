...
## Phase 72 - Ajustements Esthétiques, Cohérence des Icônes et Centrage Mathématique (Combat)

- style: Sublimation graphique de la barre d'armure en combat et centrage horizontal parfait du HUD Joueur
    - Ajout d'un padding intérieur aux jauges d'armure, application de ShaderMask pour des statistiques joueur sans conteneur de couleur, et homogénéisation totale des icônes ennemis/joueur avec centrage mathématique de la barre de vie du joueur.
