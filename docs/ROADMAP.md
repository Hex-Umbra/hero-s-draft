...
| **P-41 B** | ✅ **Partie 1 fusionnée dans `main` le 2026-09-17 (PR #40)** — la Puissance (`might`), à comportement identique, [ADR-097](../.obsidian_vault/_adr/ADR-097-puissance-unique-orientee-par-la-classe.md) · Partie 2 à venir : orientation de la Puissance par classe, conversion d'armure (`statRules`), les neuf passifs, stats de départ — [spec, §7](superpowers/specs/2026-08-07-s2-identite-de-classe-design.md), reconçue le 2026-09-17 · [plan de la partie 1](superpowers/plans/2026-09-17-p41-lot-b-partie-1-puissance.md) · [plan de la partie 2](superpowers/plans/2026-09-17-p41-lot-b-partie-2-identite-de-classe.md) | P-41 A, P-49 ; la partie 2 après la partie 1 |
