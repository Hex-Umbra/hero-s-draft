...
| **P-41 C** | **Prochain lot.** Récompenses de niveau data-driven *(indépendante, parallélisable avec A)*, filtre d'*Affinité*, et **l'écran de choix du passif** — sans lui, six des neuf passifs livrés par le lot B restent inatteignables, l'écran de sélection ne proposant que `passives.first` | B (livré) |
