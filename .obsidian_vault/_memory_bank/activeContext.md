...
Le projet vient de finaliser le **Sprint du Système de Forge v2 (v0.2.00)** :
...
1. **Système de Forge v2 (Section 2 — Version v0.2.00)** :
...
2. **Génération et Progression de la Carte (Section 5)** :
...
3. **Polissage et Responsivité en Combat (Section 6)** :
...
4. **Refactoring des Cartes de Classe "Unique" & Schémas JSON** :
...
5. **Standardisation Globale et Rééquilibrage VPM** :
...
6. **Overhaul de l'Écran de Draft Initial (`StarterDeckDraftScreen`) & Corrections** :
...
7. **Intégration et Résolution des Effets Élémentaires & Vulnérabilité (Axe 1 - Précédent)** :
...
8. **Rareté Dynamique & Fusion Interactive (Axe 2 & 4 - Précédent)** :
...
9. **Système de Forge Découplé (Axe 3 - Précédent)** :
...
10. **Système de Tutoriel Autonome & Refactoring Responsive (Ancien)** :
...
11. **Équilibrage de la Courbe de Difficulté et Vagues de Combat** :
...
12. **Assurance Qualité et Robustesse** :
...
13. **Isolation de la Journalisation du Combat (`CombatDebugLogger`)** :
...
14. **Refactoring et Finalisation des Récompenses de Boss (Version 0.0.94)** :
...
15. **Rééquilibrage des Reliques, Déclencheurs de Type de Carte et Système de Charges (Version 0.0.95)** :
 ...
 16. **Rencontre d'Échange de Reliques (Version 0.0.96)** :
 ...
 17. **Modernisation Architecturale & Découplage (Version 0.0.97)** :
 ...
 18. **Optimisations Graphiques, Performances & Animations Fluides (Version 0.0.98)** :
 ...
 19. **Système de Design & Uniformisation UI (Version 0.0.99)** :
 ...
 20. **Interface & Cartes à Jouer (UX Combat - Section 1 - Version 0.1.00)** :
