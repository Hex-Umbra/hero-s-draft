...
>
> **Note de version `0.5.2` rouverte en place deux fois le 2026-09-17** : pour P-49 (`5f168db`) —
> Maîtrise, Affinité, Armure du Berserker — puis pour ce lot (`2da3c23`) — la Force et l'Attaque
> deviennent la Puissance. **Pas encore taguée** (`docs/ROADMAP.md` §4).
>
