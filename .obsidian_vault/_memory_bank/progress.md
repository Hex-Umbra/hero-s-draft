...
|:---|:---|:---|
| Tests automatisés (jeu) | 1065 au vert | `flutter test` |
| Fichiers de test | 142 | `find test -name "*.dart" \| wc -l` |
| Analyse statique | 0 erreur (`No issues found!`) | `dart analyze` |
| Fichiers Dart (`lib/`) | 246 | `find lib -name "*.dart" \| wc -l` |
| Lignes de code (`lib/`) | 49 270 | `find lib -name "*.dart" -exec cat {} + \| wc -l` |
...
> [!NOTE]
> **Métriques ci-dessus mesurées sur `main`.** Y sont fusionnés : **P-41 lot C partie 1** — les
> récompenses de niveau en donnée, **sans que le jeu change** — par la PR #42 (2026-09-18, merge
> `152fbcc`, 11 commits, [ADR-098](../_adr/ADR-098-recompenses-de-niveau-en-donnee-et-gabarits-a-tr.md)) ;
...
>
> **Note de version `0.5.2` rouverte en place quatre fois**, même numéro à chaque fois — P-49
> (`5f168db`), lot B partie 1 (`2da3c23`), partie 2 (`83e65b9`), puis lot C partie 1 le 2026-09-18.
> **Pas encore taguée** (`docs/ROADMAP.md` §4).
