...
> [!NOTE]
> **P-41 lot B est fusionné dans `main` en entier**, métriques ci-dessus mesurées sur `main` : la
> partie 1 (la Puissance) par la PR #40 (2026-09-17, merge `e2cc24b`), la **partie 2 — l'identité de
> classe** par la **PR #41** (2026-09-18, merge `5086272`, `74c54cf`..`83e65b9`, 18 commits). Voir
...
>
> **Note de version `0.5.2` rouverte en place trois fois** : le 2026-09-17 pour P-49 (`5f168db`) —
> Maîtrise, Affinité, Armure du Berserker — puis pour la partie 1 (`2da3c23`) — la Force et l'Attaque
> deviennent la Puissance — puis le 2026-09-18 pour la partie 2 (`83e65b9`) — l'identité des trois
> classes et les neuf passifs. **Pas encore taguée** (`docs/ROADMAP.md` §4).
>
