...
final mockGameDataLoaderProvider = FutureProvider<GameDataRegistry>((ref) async {
  return const GameDataRegistry(enemies: [], heroes: [], skills: [], cards: []);
});

void main() {
  testWidgets('MapScreen displays nodes and restricts unavailable nodes', (WidgetTester tester) async {
    // 1. Arrange state
    ...
    final firstFloorNodeId = mapNodes.firstWhere((n) => n.id.contains('node_0_')).id;
