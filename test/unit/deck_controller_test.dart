...
void main() {
  group('DeckNotifier Tests', () {
    test('drawCards draws up to active drawPile size mid-turn and does not shuffle discard', () {
    ...
    test('shuffleDiscardIntoDraw manually merges discard into draw pile', () {
      ...
      expect(notifier.state.drawPile.any((c) => c.uniqueId == cardA.uniqueId), isTrue);
      expect(notifier.state.drawPile.any((c) => c.uniqueId == cardB.uniqueId), isTrue);
    });
  });
}
