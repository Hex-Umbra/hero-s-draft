...
void main() {
  ...
  test('le manifeste declare les 75 fichiers d entite, par categorie', () async {
    ...
    expect(countUnder('assets/data/passives/', 4), 7, reason: 'passifs');
  ...
  test('le registre se charge entierement depuis le vrai bundle', () async {
    ...
    expect(registry.passives, hasLength(7));
